// src/pharmacy/Prescriptions.jsx
...
import {
    CheckCircle2, Loader2, XCircle, RefreshCw, Filter,
} from 'lucide-react'
                                        ...
                                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <PermGate anyOf={['pharmacy.dispense.manage']}>
                                                    <Button size="sm" variant="outline" onClick={() => bulkMark(p.id, 'in_progress')}>
                                                        Start
                                                    </Button>
                                                    <Button
                                                        size="sm"
                                                        onClick={async () => {
                                                            try {
                                                                await updatePrescriptionStatus(p.id, { status: 'dispensed' });
                                                                toast.success('Prescription updated', { description: 'Status → dispensed' });
                                                                await load();
                                                            } catch (e) {
                                                                toast.error('Update failed', { description: e?.response?.data?.detail || 'Retry' });
                                                            }
