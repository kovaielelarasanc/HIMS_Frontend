        ...
        <div className="rounded-xl border bg-white p-3 space-y-4 text-black">
            ...
            <CreateRow
                ...
                fields={[
                    ...
                    {
                        name: 'type',
                        placeholder: 'Type (General/Private/ICU)',
                        required: true,
                    },
                ]}
            />
                ...
                fields={[
                    {
                        ...
                        options: rooms.map((r) => ({
                            value: r.id,
                            label: `Ward ${r.ward_id} • Room ${r.number} (${r.type})`,
                        })),
                        required: true,
                    },
...
function CreateRow({ title, fields, onSubmit }) {
    ...
    return (
        <form
            onSubmit={submit}
            className="rounded-lg border bg-gray-50 p-3 grid gap-3 md:grid-cols-4"
        >
            ...
            {fields.map((fld) =>
                fld.type === 'select' ? (
                    <select
                        ...
                        value={f[fld.name] || ''}
                        onChange={(e) =>
                            setF((s) => ({ ...s, [fld.name]: e.target.value }))
                        }
