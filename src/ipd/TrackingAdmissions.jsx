...
export default function TrackingAdmissions() {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            // sort by admitted_at desc (latest on top)
            admissions.sort(
                (x, y) =>
            ...
            // fetch patient UHIDs (limited to 100 ids for safety)
            ...
            setError(
                e?.response?.data?.detail ||
                    'Failed to load active admissions. Please try again.'
            )
            setRows([])
            setBedsById({})
            setPmap({})
            ...
            <div className="mx-auto mb-4 flex max-w-6xl flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-slate-600">
                        View all currently admitted in-patients, along with their
                        admission number, UHID and allocated bed. Use the search box to
                        quickly find a patient or admission, and open the admission
                        detail screen for nursing, vitals, orders and discharge.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm md:flex-row md:items-center md:justify-between">
                    <div className="w-full md:max-w-md">
                        ...
                        <p className="mt-1 text-[11px] text-slate-500">
                            Tip: Try typing admission number (ADM-000123), UHID or bed
                            code.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 md:justify-end">
                        <div className="text-xs text-slate-600">
                            ...
                            of {totalCount} active admissions
                        </div>
                        <button
                            type="button"
                            onClick={loadData}
