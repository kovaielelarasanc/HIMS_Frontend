                ...
                <div className="max-h-[88vh] overflow-auto p-6">
                    ...
                    <div
                        className={[
                            ...
                            drag ? 'bg-slate-50 border-slate-400' : 'bg-white border-slate-200',
                        ].join(' ')}
                        onDragOver={(e) => {
                            e.preventDefault()
                            setDrag(true)
                    ...
                    {/* Preview */}
                    {preview ? (
                        <div className="mt-4 rounded-3xl border border-slate-200 bg-white p-4 space-y-3">
                    ...
                    <div className="sticky bottom-0 mt-6 -mx-6 px-6 py-4 bg-white border-t border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        <Button
                            variant="outline"
                            className="rounded-2xl"
                            onClick={resetAll}
