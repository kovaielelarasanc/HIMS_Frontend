                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-muted-foreground mt-1">
                        ...
                        <ArrowRight className="inline w-3 h-3 mx-1" /> To: {r.to_location?.name || r.to_location_id}
                      </div>
                    </div>
      ...
      <Dialog open={filterOpen} onOpenChange={setFilterOpen}>
        <DialogContent className="max-w-[720px] rounded-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {/* ✅ FIXED: Status as Select (no empty SelectItem values) */}
            <div className="space-y-1">
              <Label>Status</Label>
              <Select
                value={filters.status || undefined}
                onValueChange={(v) => setFilters((p) => ({ ...p, status: v === SELECT_ALL ? "" : v }))}
              >
            ...
            {/* ✅ FIXED: From Location (no value="") */}
            <div className="space-y-1">
              <Label>From Location</Label>
              <Select
                value={filters.from_location_id || undefined}
                onValueChange={(v) => setFilters((p) => ({ ...p, from_location_id: v === SELECT_ALL ? "" : v }))}
              >
                <SelectTrigger className="rounded-xl">
            ...
            {/* ✅ FIXED: To Location (no value="") */}
            <div className="space-y-1">
              <Label>To Location</Label>
              <Select
                value={filters.to_location_id || undefined}
                onValueChange={(v) => setFilters((p) => ({ ...p, to_location_id: v === SELECT_ALL ? "" : v }))}
              >
                <SelectTrigger className="rounded-xl">
                  <SelectValue placeholder="All" />
                </SelectTrigger>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-1 space-y-3">
              <div className="space-y-1">
                <Label>From Location *</Label>
                <Select
                  value={createPayload.from_location_id || undefined}
                  onValueChange={(v) => setCreatePayload((p) => ({ ...p, from_location_id: v }))}
                >
                  <SelectTrigger className="rounded-xl">
              ...
              <div className="space-y-1">
                <Label>To Location *</Label>
                <Select
                  value={createPayload.to_location_id || undefined}
                  onValueChange={(v) => setCreatePayload((p) => ({ ...p, to_location_id: v }))}
                >
                  <SelectTrigger className="rounded-xl">
                    <SelectValue placeholder={catalogLoading ? "Loading..." : "Select"} />
                  </SelectTrigger>
              ...
              <div className="space-y-1">
                ...
                <Select
                  value={createPayload.priority || undefined}
                  onValueChange={(v) => setCreatePayload((p) => ({ ...p, priority: v }))}
                >
                  <SelectTrigger className="rounded-xl">
                    <SelectValue />
                  </SelectTrigger>
                            ...
                            <div className="mt-3 grid grid-cols-2 gap-2 items-end">
                              <div className="space-y-1">
                                ...
                                <Input
                                  ...
                                  onChange={(e) => updateLine(li.item_id, { requested_qty: e.target.value })}
                                  className="rounded-xl"
                                />
                              </div>
                              ...
                              <div className="flex items-center justify-between border rounded-xl px-3 py-2">
                                ...
                                <Switch
                                  checked={!!li.is_stat}
                                  onCheckedChange={(v) => updateLine(li.item_id, { is_stat: v })}
                                />
                              </div>
                              ...
                              <div className="col-span-2 space-y-1">
                                ...
                                <Input
                                  value={li.remarks}
                                  onChange={(e) => updateLine(li.item_id, { remarks: e.target.value })}
