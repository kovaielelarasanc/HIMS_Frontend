// src/pharmacy/GRN.jsx
import { useEffect, useMemo, useState } from 'react'
import { Plus, Trash2, Loader2, ReceiptText } from 'lucide-react'
import { listGRN, createGRN, listSuppliers, listLocations, listMedicines, listPO } from '../api/pharmacy'
    ...
    const save = async () => {
        ...
        try {
            ...
            toast.success('GRN created', {
                description: id ? `GRN-${String(id).padStart(6, '0')} • ${payload.items.length} line(s) • ${totals.qty} units` : 'Stock received.',
            })
        } catch (e) {
                    ...
                    <div className="grid gap-3 md:grid-cols-3 text-sm">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectItem value={NONE}>—</SelectItem> {/* ✅ sentinel, not empty string */}
                                    {pos.map(p => (
