// frontend/src/patients/PatientMasters.jsx
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">
                            Configure payers, TPAs and credit plans used in patient registration & billing.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        {!loading &&
                            filtered.map((t, idx) => (
                                <tr key={t.id} className="border-t text-xs">
                                    ...
                                    <td className="p-2 font-mono text-[11px] text-gray-800">{t.code}</td>
                                    <td className="p-2 text-gray-800">{t.name}</td>
                                    <td className="p-2 text-gray-800">{payerMap[t.payer_id]?.name || '—'}</td>
                                    <td className="p-2 text-gray-800">{t.contact_person || '—'}</td>
